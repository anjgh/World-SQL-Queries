...
CREATE TABLE eecs3421countrylanguage (
    countrycode character(3) NOT NULL,
...
COPY eecs3421city (id, name, countrycode, district, population) FROM stdin;
...
COPY eecs3421country (code, name, continent, region, surfacearea, indepyear, population, lifeexpectancy, gnp, gnpold, localname, governmentform, headofstate, capital, code2) FROM stdin;
...
COPY eecs3421countrylanguage (countrycode, countrylanguage, isofficial, percentage) FROM stdin;
...
ALTER TABLE ONLY eecs3421country
    ADD CONSTRAINT country_pkey PRIMARY KEY (code);

ALTER TABLE ONLY eecs3421countrylanguage
    ADD CONSTRAINT countrylanguage_pkey PRIMARY KEY (countrycode, countrylanguage);

ALTER TABLE ONLY eecs3421country
    ADD CONSTRAINT country_capital_fkey FOREIGN KEY (capital) REFERENCES eecs3421city(id);

ALTER TABLE ONLY eecs3421countrylanguage
    ADD CONSTRAINT countrylanguage_countrycode_fkey FOREIGN KEY (countrycode) REFERENCES eecs3421country(code);
